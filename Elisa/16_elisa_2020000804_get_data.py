...
import os
path_image= r'E:\Downloads_HD\AnaliseImagem-ELISA\Analises_040820'

files= os.listdir(path_image)
images=[]
image = cv2.imread(path_image+'\\'+'HP_Amarelo_Branco 001.jpg',1)
image=cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
images.append([image.copy(),'hp_b'])
image = cv2.imread(path_image+'\\'+'HP_Amarelo_Transparente 001.jpg',1)
image=cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
images.append([image.copy(),'hp_t'])
