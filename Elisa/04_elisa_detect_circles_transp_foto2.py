...
image = cv2.imread(path_image+'\\Amarelo_placa-transp_230620-001_scanner.jpg',1)
...
gray3=(image_HSV[:,:,1]>49).astype(int)*200
circles = cv2.HoughCircles(image_HSV[:,:,1], cv2.HOUGH_GRADIENT, 1.2, 10,minRadius=20,maxRadius=200)
