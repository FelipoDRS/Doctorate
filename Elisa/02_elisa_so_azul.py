...
plt.figure();plt.imshow(image_HSV[:,:,0],cmap='gray');plt.colorbar()
plt.figure();plt.imshow(image_HSV[:,:,1],cmap='gray');plt.colorbar()
plt.figure();plt.imshow(image_HSV[:,:,2],cmap='gray');plt.colorbar()
